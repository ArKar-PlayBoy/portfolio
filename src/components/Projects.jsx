  ...
  const portfolioItems = [
    {
      ...
      category: 'Full-Stack',
      problem: 'Cafe operations relied on manual ordering, paper-based inventory, and no cost visibility',
      built: 'Built a Laravel platform with role-based access, AI drink suggestions, Stripe/KBZ Pay, and FIFO inventory with unit-cost analytics.',
